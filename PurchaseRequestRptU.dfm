object PurchaseRequestRpt: TPurchaseRequestRpt
  Left = 230
  Top = 350
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Laporan Purchase Request'
  ClientHeight = 479
  ClientWidth = 1122
  Color = clBtnFace
  ...
  object ClearVendor: TCheckBox
    Left = 730
    Top = 8
    Width = 120
    Height = 17
    Alignment = taLeftJustify
    Caption = 'Bersihkan Vendor'
    TabOrder = 11
    OnClick = ClearVendorClick
  end
  object ClearPart: TCheckBox
    Left = 730
    Top = 32
    Width = 120
    Height = 17
    Alignment = taLeftJustify
    Caption = 'Bersihkan Part'
    TabOrder = 12
    OnClick = ClearPartClick
  end
end
