object Apps: TApps
  ...
  object Perubahan: TMemo
    ...
    Lines.Strings = (
      '31/07/2026 (6.2.1.6)'
      '- Penambahan Kolom Odo di Laporan Uang Harian Driver'
      '- Perbaikan Bug di Menu Purchase Request, Memo List, dan Buget.'
      ''
      '08/07/2026 (6.2.1.5)'
      ...
      ''
      '19/05/2026 (6.2.1.3)'
      '- Penambahan Menu Laporan Absensi Driver dan Helper'
      ''
      '12/05/2026 (6.2.1.2)'
      '- Perbaikan Menu Laporan Absensi karyawan'
      '- Perbaikan Cancel PO'
      ''
      '07/05/2026 (6.2.1.1)'
