object ReservationOLList: TReservationOLList
  Left = 283
  Top = 206
  BorderIcons = [biSystemMenu]
  BorderStyle = bsNone
  Caption = 'Daftar Pesanan melalui Web'
  ClientHeight = 430
  ClientWidth = 740
  Color = clBtnFace
  ...
  object GridOrderList: TZColorStringGrid
    Left = 8
    Top = 40
    Width = 722
    Height = 353
    ...
    FixedCols = 0
    TabOrder = 1
    OnDblClick = GridOrderListDblClick
    OnSelectCell = GridOrderListSelectCell
  ...
  object GroupCompany: TGroupBox
    ...
    object DatesTo: TDateTimePicker
      Left = 176
      Top = 9
      Width = 89
      Height = 21
