...
var
  WorkOrderReprint: TWorkOrderReprint;
...
procedure TWorkOrderReprint.SelesaiClick(Sender: TObject);
begin
  WorkOrderReprint.Close;
end;

procedure TWorkOrderReprint.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TWorkOrderReprint.Init;
begin
...
procedure TWorkOrderReprint.RefreshData;
var Qry:TADOQuery;
    StrQry:String;
    IntCount:Integer;
begin
...
procedure TWorkOrderReprint.RefreshGrid;
...
procedure TWorkOrderReprint.FormShow(Sender: TObject);
begin
  Init;
  RefreshData;
  RefreshGrid;
...
procedure TWorkOrderReprint.StrGridSelectCell(Sender: TObject; ACol,
  ARow: Integer; var CanSelect: Boolean);
begin
  IntRow:=Arow;
end;

procedure TWorkOrderReprint.StrGridDblClick(Sender: TObject);
begin
