object BudgetVehicleList: TBudgetVehicleList
  Left = 278
  Top = 138
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Daftar Budget Armada'
  ClientHeight = 429
  ClientWidth = 806
  Color = clBtnFace
  ...
  object GridVhcBudget: TZColorStringGrid
    Left = 8
    Top = 40
    Width = 788
    Height = 353
    ...
    FixedCols = 0
    TabOrder = 1
    OnDblClick = GridVhcBudgetDblClick
    OnSelectCell = GridVhcBudgetSelectCell
