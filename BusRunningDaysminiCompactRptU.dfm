object BusRunningDaysminiCompactRpt: TBusRunningDaysminiCompactRpt
  Left = 255
  Top = 99
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Running Days Mini [Compact]'
  ClientHeight = 588
  ClientWidth = 1004
  Color = clBtnFace
