...
procedure TSubMenuList.LoadData;
var Qry:TADOQuery;
    StrQry:String;
    IntCount:Integer;
begin
...
procedure TSubMenuList.RefreshList;
...
procedure TSubMenuList.AskDelete(SubMenuId:String);
var Qry:TADOQuery;
...
procedure TSubMenuList.FormShow(Sender: TObject);
begin
  Cari.Text:='';
  Init;
  LoadData;
...
procedure TSubMenuList.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TSubMenuList.SelesaiClick(Sender: TObject);
begin
  SubMenuList.Close;
end;

procedure TSubMenuList.CariChange(Sender: TObject);
...
procedure TSubMenuList.StrGridSelectCell(Sender: TObject; ACol,
  ARow: Integer; var CanSelect: Boolean);
begin
  IntRow:=ARow;
end;

procedure TSubMenuList.StrGridDblClick(Sender: TObject);
begin
