object DailySalesRecapRpt: TDailySalesRecapRpt
  Left = 386
  Top = 442
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Laporan Rekapitulasi Pemesanan Harian'
  ClientHeight = 542
  ClientWidth = 1028
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object rbpil3: TRadioButton
      Left = 248
      Top = 12
      Width = 109
      Height = 17
      Caption = 'DD-MMMM-YYYY'
      TabOrder = 2
    end
  end
end
