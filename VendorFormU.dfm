object VendorForm: TVendorForm
  ...
  object GroupInput: TPanel
    ...
    object ContactPerson: TEdit
      Left = 0
      Top = 96
      Width = 185
      Height = 21
      TabOrder = 3
      OnKeyPress = ContactPersonKeyPress
    end
    object NoHP: TEdit
      Left = 0
      Top = 120
    ...
    object TermOfPayment: TComboBox
      Left = 0
      Top = 144
      Width = 137
      Height = 21
