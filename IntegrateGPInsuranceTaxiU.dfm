object IntegrateGPInsuranceTaxi: TIntegrateGPInsuranceTaxi
  Left = 240
  Top = 197
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Integrate Ansuransi Taxi'
  ClientHeight = 494
  ClientWidth = 701
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object Label4: TLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = 'Last GL Number'
    end
    object GPIndex: TEdit
      Left = 112
      Top = 12
      Width = 169
      Height = 21
    ...
    object GPLastGL: TEdit
      Left = 112
      Top = 36
      Width = 41
      Height = 21
      TabOrder = 1
      OnKeyPress = GPLastGLKeyPress
    end
  end
