...
var
  UserTreeMenuList: TUserTreeMenuList;
...
procedure TUserTreeMenuList.Init;
...
procedure TUserTreeMenuList.LoadData;
var Qry:TADOQuery;
    StrQry:String;
    IntCount:Integer;
begin
...
procedure TUserTreeMenuList.RefreshList;
var IntCount:Integer;
begin
...
procedure TUserTreeMenuList.AskDelete(UserGrpTreeMenuId:String);
var Qry:TADOQuery;
...
procedure TUserTreeMenuList.SelesaiClick(Sender: TObject);
begin
  Close;
end;

procedure TUserTreeMenuList.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TUserTreeMenuList.FormShow(Sender: TObject);
begin
  Cari.Text:='';
  Init;
  LoadData;
...
procedure TUserTreeMenuList.CariChange(Sender: TObject);
...
procedure TUserTreeMenuList.StrGridSelectCell(Sender: TObject; ACol,
  ARow: Integer; var CanSelect: Boolean);
begin
  IntRow:=ARow;
end;

procedure TUserTreeMenuList.StrGridDblClick(Sender: TObject);
begin
