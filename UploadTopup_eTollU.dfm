object UploadTopup_eToll: TUploadTopup_eToll
  Left = 296
  Top = 108
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Daftar Trx Etoll yang akan diupload'
  ClientHeight = 414
  ClientWidth = 564
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 131
    Height = 13
    Caption = 'Pilih file yang akan diupload'
  end
  object btnCariDriver: TSpeedButton
    Left = 440
    Top = 6
    Width = 23
    Height = 23
  ...
  object lbl1: TLabel
    ...
    Width = 109
    Height = 13
    Caption = 'No EToll tidak terdaftar'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clRed
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
