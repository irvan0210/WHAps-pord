...
type
  TPurchaseRequestRpt = class(TForm)
...
var
  PurchaseRequestRpt: TPurchaseRequestRpt;
...
constructor TPurchaseRequestRpt.Create(AOwner:TComponent;Form_Request:String='';Form_Function:String='');
begin
...
procedure TPurchaseRequestRpt.Init;
begin
  SBU.Items.Clear;
  SBU.ItemIndex:=-1;
  SBU.Text:='';
...
procedure TPurchaseRequestRpt.InitGrid;
...
procedure TPurchaseRequestRpt.RefreshCombo;
var Qry:TADOQuery;
    StrQry:String;
    IntCount:Integer;
begin
...
procedure TPurchaseRequestRpt.RefreshLocation;
var Qry:TADOQuery;
    StrQry:String;
    IntCount:Integer;
    StrCompanyId:String;
...
procedure TPurchaseRequestRpt.RefreshData;
var Qry:TADOQuery;
...
procedure TPurchaseRequestRpt.RefreshGrid;
var
...
procedure TPurchaseRequestRpt.SelesaiClick(Sender: TObject);
begin
  Close;
end;

procedure TPurchaseRequestRpt.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TPurchaseRequestRpt.FormShow(Sender: TObject);
begin
  Init;
  InitGrid;
  RefreshCombo;
...
procedure TPurchaseRequestRpt.LihatClick(Sender: TObject);
begin
  RefreshData;
  RefreshGrid;
end;

procedure TPurchaseRequestRpt.StrGridSelectCell(Sender: TObject; ACol,
  ARow: Integer; var CanSelect: Boolean);
begin
  IntRow:=ARow;
end;

procedure TPurchaseRequestRpt.StrGridDblClick(Sender: TObject);
var IntCount:Integer;
begin
...
procedure TPurchaseRequestRpt.CariChange(Sender: TObject);
...
procedure TPurchaseRequestRpt.DepartmentChange(Sender: TObject);
begin
  if Department.Text<>'' then
    DepartmentDisp.Text:=DepartmentArr[Department.ItemIndex][1];
end;

procedure TPurchaseRequestRpt.MonthChange(Sender: TObject);
begin
 // RefreshData;
 // RefreshGrid;
end;

procedure TPurchaseRequestRpt.SBUChange(Sender: TObject);
begin
  RefreshLocation;
end;

procedure TPurchaseRequestRpt.LocationChange(Sender: TObject);
begin
  RefreshData;
  RefreshGrid;
end;

procedure TPurchaseRequestRpt.CariVendorClick(Sender: TObject);
begin
 VendorList:=TVendorList.Create(Self,'REPORT PR',True);
end;

procedure TPurchaseRequestRpt.SpeedButton1Click(Sender: TObject);
begin
  PartDetailList:=TPartDetailList.Create(Self,'PURCHESREQUSESTRPT');
end;

procedure TPurchaseRequestRpt.ClearVendorClick(Sender: TObject);
begin
...
procedure TPurchaseRequestRpt.ClearPartClick(Sender: TObject);
begin
...
procedure TPurchaseRequestRpt.ToXCelClick(Sender: TObject);
begin
  if ToExcel4(StrGrid) then ShowMessage('Export ke Excel Berhasil');
end;

procedure TPurchaseRequestRpt.Search;
...
procedure TPurchaseRequestRpt.btn_cariClick(Sender: TObject);
begin
