...
type
  ...
  private
    ...
    DriverComplainID:String;
    procedure Init;
    procedure RefreshList;
  public
    { Public declarations }
  constructor Create(AOwner:TComponent;DriverComplain_ID:String='');Overload;
...
constructor TResponsDriverComplaint.Create(AOwner:TComponent;DriverComplain_ID:String='');
begin
 // Initiation:=True;
