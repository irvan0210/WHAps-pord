object EmployeeContractList: TEmployeeContractList
  Left = 408
  Top = 202
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Daftar Kontrak Karyawan'
  ClientHeight = 389
  ClientWidth = 655
  Color = clBtnFace
  ...
  object chk_Aktif_Sampaidengan: TCheckBox
    Left = 219
    Top = 12
    Width = 86
    Height = 17
    ...
    Caption = 'Aktif s/d '
    TabOrder = 7
    OnClick = chk_Aktif_SampaidenganClick
  end
end
