object KetidakSesuaianDanPerbaikanList: TKetidakSesuaianDanPerbaikanList
  Left = 268
  Top = 298
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Ketidak Sesuaian Dan Perbaikan List'
  ClientHeight = 545
  ClientWidth = 1276
  Color = clBtnFace
  ...
  object GridCCP: TZColorStringGrid
    ...
    FixedCols = 0
    TabOrder = 1
    OnDblClick = GridCCPDblClick
    OnSelectCell = GridCCPSelectCell
  ...
  object CBFilterBy: TComboBox
    ...
    ItemIndex = 0
    TabOrder = 4
    Text = 'Tanggal Ketidaksesuaian dan Perbaikan'
    Items.Strings = (
      'Tanggal Ketidaksesuaian dan Perbaikan'
      'Tanggal Komplain')
  end
